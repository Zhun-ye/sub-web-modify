  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: { "自有后端": "https://sub-server.198976.xyz" },
        backendOptions: [ { value: "https://sub-server.198976.xyz" } ],
        remoteConfig: [
          {
            label: "CM规则",
            options: [
